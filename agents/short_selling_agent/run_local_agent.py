...
parser = argparse.ArgumentParser(
    description="Run the ADK 2.0 short-selling pipeline with a mandatory execution date."
)
...
parser.add_argument(
    ...
    help="MANDATORY: Target execution date in YYYY-MM-DD format (e.g., 2026-07-10)."
)
...
async def main():
    ...
    print("--- Starting ADK 2.0 Short-Selling Pipeline Run ---")
    ...
    # ==========================================
    prompt_text = f"Run the short-selling pipeline for {args.run_date}."
    ...
    # ==========================================
    print(f"🚀 Executing short-selling pipeline for target date: '{args.run_date}'...\n")
    ...
    print(f"--- Pipeline Output for {args.run_date} ---\n")
