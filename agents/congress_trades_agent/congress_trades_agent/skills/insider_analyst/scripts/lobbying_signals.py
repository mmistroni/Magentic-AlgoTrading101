...
def get_lobbying_data(
    ...
    """Loads get_lobbying_signals.sql and queries BigQuery for corporate lobbying spend.
    ...
    Returns:
        List[Dict[str, Any]]: List of dictionary records containing lobbying metrics.
    """
